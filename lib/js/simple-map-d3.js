...
function SimpleMapD3(o) {
  ...
  smd.loadData = function(data) {
    ...
    smd.topo().canvas().projection().render().fit().legend();
  ...
  smd.canvas = function() {
    ...
    smd.featureGroup = smd.canvas.append('g');
    ...
    if (smd.options.colorScale === 'quantile' &&
      ...
      smd.legendGroup
        ...
        .enter().append('rect')
          ...
          .attr('height', 10)
          .attr('x', 20)
          .attr('y', function(d, i) { return (i * 10 * 2) + 40; })
      ...
      smd.legendGroup
        ...
        .enter().append('text')
          ...
          .attr('font-size', '10')
          .attr('x', 35)
          .attr('y', function(d, i) { return (i * 10 * 2) + 49; })
          .text(function(d, i) { return '>= ' + formatter(d.toFixed(2)); });
    }
